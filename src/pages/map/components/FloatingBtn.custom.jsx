...
import CatchingPokemonIcon from '@mui/icons-material/CatchingPokemon'; // POKELX - Imported Pokemon Icon
import { launchApp } from '../dialogs/LaunchApp.js'  // POKELX - Imported launchApp function from LaunchApp.js
      ...
      >
        ...
        {!!DonorIcon && (
          <Fab
            color="secondary"
            size={fabSize}
            // POKELX - Added launchApp exportable from LaunchApp.js
            onClick={ launchApp }
            title={t('donor_menu')}
            disabled={disabled}
          >
            <CatchingPokemonIcon fontSize={iconSize} sx={{ color: 'white', transform: 'rotate(180deg)' }} /> 
          </Fab>
          // POKELX - Prev: <DonorIcon fontSize={iconSize} sx={{ color: 'white' }} />
        )}
        {reactControls && (
          <>
            <Fab
